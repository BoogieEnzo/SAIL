(*Generated by Lem from abis/riscv/abi_riscv_section_header_table.lem.*)
...
let string_of_abi_mips64_section_type0 m:string=
   "Invalid MIPS64 section type"
    
(** Special sections *)

(*val abi_mips64_special_sections : Map.map string (natural * natural)*)
let abi_amg64_special_sections1:((string),(Nat_big_num.num*Nat_big_num.num))Pmap.map=
...
let abi_mips64_special_sections_large_code_model0:((string),(Nat_big_num.num*Nat_big_num.num))Pmap.map=
   (Lem_map.fromList (instance_Map_MapKeyType_var_dict instance_Basic_classes_SetType_var_dict) [
    (* FIXME *)
  ])
